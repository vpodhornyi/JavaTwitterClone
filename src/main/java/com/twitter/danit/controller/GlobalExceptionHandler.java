...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Object> handleItemNotFoundException(AbstractException exception) {
    final ResponseError responseError = new ResponseError(exception.getRawStatusCode(),
        exception.getMessage(),
        exception.getShowMessage());
  ...
  public ResponseEntity<Object> internalServerErrorException(Exception exception) {
    ...
    final ResponseError responseError = new ResponseError(statusCode,
        serverErrorMessage,
